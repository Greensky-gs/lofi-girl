            ...
            .setFields(
                ...
                },
                {
                    ...
                    value: interaction.client.langs.getText(interaction, 'infoBot', 'linksContent', {
                        ...
                        lofigirl:
                            interaction.client.user.id === '1037028318404419596'
                                ? 'https://discord.com/api/oauth2/authorize?client_id=1096671831022387250&permissions=2150910208&scope=bot%20applications.commands'
